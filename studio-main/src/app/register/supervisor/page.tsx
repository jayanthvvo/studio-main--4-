// src/app/register/supervisor/page.tsx
...
export default function SupervisorRegisterPage() {
  ...
  const [fullName, setFullName] = useState("Dr. Evelyn Reed");
  ...
  const handleRegister = async (e: FormEvent) => {
    ...
    try {
      const response = await fetch('/api/auth/register', {
        ...
        body: JSON.stringify({ email, password, role: 'supervisor', displayName: fullName }),
      });
    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-background p-4">
      ...
      <Card className="w-full max-w-sm">
        <CardHeader>
          ...
          <CardDescription>
            Create your ThesisFlow supervisor account.
          </CardDescription>
        </CardHeader>
        <CardContent>
